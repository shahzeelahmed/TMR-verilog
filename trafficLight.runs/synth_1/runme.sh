...
HD_PWD='C:/Users/himan/OneDrive/Desktop/finaYRpro/trafficLight - Copy/trafficLight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_system.vds -m64 -mode batch -messageDb vivado.pb -notrace -source spi_system.tcl
